...
app.MapControllerRoute( // uygulamanýn kullanacaðý routing yönlendirme ayarý
    ...
    name: "default", // rouute adý
    pattern: "{controller=Home}/{action=Index}/{id?}"); // eðer adres çubuðundan uygulamaya bir controller adý ve action adý gönderilmezse varsayýlan olarak home controllerý ve içindeki index isimli action ý çalýþtýrýlsýn. Id deðeri ise ? iþareti ile parametrik yani isteðe baðlý belirtilmiþ.
